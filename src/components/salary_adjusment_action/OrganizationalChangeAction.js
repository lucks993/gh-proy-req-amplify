...
import { headerData, rowData } from "./sampleDataOrg";
import "./OrganizationalChangeAction.scss";
import "../../assets/scss/globa.scss";
class OrganizationalChangeAction extends React.Component {
  constructor(props) {
    let list = [];
    ...
    super(props);
    this.state = {
      title: "Aprobaciones: Cambios Organizacionales",
      checked: false,
      dataContent: [0],
...
export default OrganizationalChangeAction;
